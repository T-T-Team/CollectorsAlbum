...
public final class CategoryRegistry {
    ...
    public static final Supplier<AlbumCategoryType<DefaultAlbumCategory>> CATEGORY = REGISTRY.register("category", () -> new AlbumCategoryType<>(DefaultAlbumCategory.CODEC));
}
