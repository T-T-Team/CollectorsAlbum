...
public final class ItemDropProviderType<I extends ItemDropProvider> {
    ...
    public static final Codec<ItemDropProvider> INSTANCE_CODEC = CollectorsAlbumRegistries.ITEM_DROP_PROVIDER.codec().dispatch(ItemDropProvider::getType, ItemDropProviderType::codec);
