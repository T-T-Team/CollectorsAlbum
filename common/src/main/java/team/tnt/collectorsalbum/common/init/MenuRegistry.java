...
public final class MenuRegistry {
    ...
    public static final PlatformRegistry.Reference<MenuType<AlbumCategoryMenu>> ALBUM_CATEGORY = HELPER.register("album_category", AlbumCategoryMenu::new, Identifier.STREAM_CODEC);
}
