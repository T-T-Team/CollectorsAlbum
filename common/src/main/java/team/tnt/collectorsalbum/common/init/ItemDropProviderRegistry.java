...
public final class ItemDropProviderRegistry {
    ...
    public static final PlatformRegistry.Reference<ItemDropProviderType<RandomListItemDropProvider>> RANDOM_ITEM_DROP_PROVIDER = REGISTRY.register("random_item", () -> new ItemDropProviderType<>(RandomListItemDropProvider.CODEC));
