...
public final class SoundRegistry {
    ...
    public static final RegistryObject<SoundEvent> FLIP_COMMON = REGISTRY.register("flip_common", () -> SoundEvent.createFixedRangeEvent(new ResourceLocation(CollectorsAlbum.MODID, "flip_common"), 16));
